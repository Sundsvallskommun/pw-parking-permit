...
public class CheckCardExistsTaskWorker extends AbstractTaskWorker {
	...
	CheckCardExistsTaskWorker(final EngineClient engineClient, final CaseDataClient caseDataClient, final FailureHandler failureHandler) {
	...
	private boolean isCardCreated(final Errand errand) {
