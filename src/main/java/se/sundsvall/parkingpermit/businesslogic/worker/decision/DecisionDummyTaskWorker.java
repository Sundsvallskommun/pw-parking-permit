...
@Component
@ExternalTaskSubscription("DecisionDummyTask")
public class DecisionDummyTaskWorker extends AbstractWorker {
	private static final Logger LOGGER = LoggerFactory.getLogger(DecisionDummyTaskWorker.class);

	@Override
	public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
		try {
			LOGGER.info("Execute Worker for DecisionDummyTask");
