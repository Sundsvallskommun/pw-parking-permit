...
public final class Constants {
	...
	public static final String TENANT_ID = "PARKING_PERMIT"; // Namespace where process is deployed, a.k.a tenant (must match setting in application.yaml)
	...
	public static final String PROCESS_VARIABLE_APPLICANT_NOT_RESIDENT_OF_MUNICIPALITY = "applicantNotResidentOfMunicipality";
	public static final String PROCESS_VARIABLE_ASSIGNED_TO_ADMINISTRATOR = "assignedToAdministrator";
	...
	public static final String PROCESS_VARIABLE_CARD_EXISTS = "cardExists";
	public static final String PROCESS_VARIABLE_TIME_TO_SEND_CONTROL_MESSAGE = "timeToSendControlMessage";
	public static final String PROCESS_VARIABLE_IS_APPEAL = "isAppeal";
	public static final String PROCESS_VARIABLE_IS_IN_TIMELINESS_REVIEW = "isInTimelinessReview";
	public static final String PROCESS_VARIABLE_STATUS = "status";
	public static final String PROCESS_VARIABLE_STATUS_DESCRIPTION = "statusDescription";
	...
	/*
	 * Phases and statuses that this process itself assigns are defined as input parameters in the bpmn schema, which is
	 * their single source of truth - do not mirror them here. Only the ones that this process reads back, or sets outside
	 * of the schema, belong below.
	 */
