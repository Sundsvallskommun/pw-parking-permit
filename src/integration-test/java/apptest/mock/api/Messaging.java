...
public class Messaging {
	...
	public static String mockMessagingWebMessagePost(final String municipalityId, final String scenarioName, final String requiredScenarioState, final String newScenarioState, final ContentPattern<?> bodyPattern) {
		return stubFor(post(urlEqualTo(String.format("/api-messaging/%s/webmessage", municipalityId)))
			.inScenario(scenarioName)
			.whenScenarioStateIs(requiredScenarioState)
			.withHeader("Authorization", equalTo("Bearer MTQ0NjJkZmQ5OTM2NDE1ZTZjNGZmZjI3"))
			.withRequestBody(bodyPattern)
